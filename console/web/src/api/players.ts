...
export const playersApi = {
  ...
  vitals: (playerId: string) => api<{ currentHealth?: number | null; maxHealth?: number; hydration?: number | null; maxHydration?: number; spiceAddictionLevel?: number | null; maxSpiceAddictionLevel?: number; capabilities: Record<string, unknown>; reason?: string }>(`/api/players/${encodeURIComponent(playerId)}/vitals`),
